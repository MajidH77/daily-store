...
return (
  ...
  p: 2,
          ...
          <Typography paddingTop={2}  align="center" id="keep-mounted-modal-title" variant="h4" fontSize={30}>
           سفارش شما ثبت شد.
          </Typography>
                  ...
                  <Grid container justifyContent="space-between" py={2}>
                    ...
                    {new Intl.NumberFormat('fa-US', {style : "decimal" }).format(state.total)} <span>تومان </span>
                        ...
                        <Grid container py={1} justifyContent="space-around"  >
                            ...
                            <Button
                            sx={{  borderRadius: 3, lineHeight: "2.3", fontSize:"13px"}}  
                            size="small"
