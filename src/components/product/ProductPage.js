...
return (
 ...
 <Container  maxWidth="xl"   >
      ...
      <Grid container spacing={2} padding={0} mt={1}>
...
{(data.product.color.length > 0) && 
  <Grid container mt={3}  >
      ...
      {(!!data.product.color) && data.product.color.map( color => 
        ...
        {colorx === color.hex? <FaCheck size="18px"  style={{color:"#cfcfd1ff",}}/> : null}
          </Grid>
        </button>
      ...
      <Grid item sx={{ position: {xs:'static' , lg: 'sticky'} , top:{xs:"0px" , lg:"10px" }}} xs={10} md={3} mt={1}  >
         ...
         <div>
                           ...
                           <Grid container  >
                                ...
                                <div  style={{width:"40px",padding:"10px 20px 0px 0px"}} >
                                  < FaShop color="#555353" size={20}/>
                                </div>

                                <div  >
                                  <Typography fontSize="16px" pl={3}>
                                    {data.product.seller.name}
                                  </Typography>
                                  <div>
                                   
                                  <Typography color={sellerFunctionColor(data.product.seller)} fontSize="15px" pl={3}>
