...
import {  Card, CardContent,  CardMedia, Typography , Divider, Button , Grid} from "@mui/material";
  ...
  return (
   ...
   <Link
    ...
    <CardContent  style={{ padding: "10px 10px 2px 10px"}}>
        ...
        <Typography  sx={{ minHeight: { xs: '70px', lg: '48px' } }} 
              component="p"
              variant="h9"
              color="text.primary"
              fontWeight={500}
...
<Grid container justifyContent="space-evenly" style={{ padding:"0px 8px 8px 8px"}}>
        ...
        {   isInCart(state, slug) ?
            ...
            <Button
              variant="outlined"
              size="medium"
              sx={{ width: "98%", borderRadius: 3, lineHeight:"1.7" }}
          ...
          <Typography color="#0066ff" width="19px" fontSize="18px" textAlign="center" lineHeight="32px" component="p" variant="p" fontWeight={400}
